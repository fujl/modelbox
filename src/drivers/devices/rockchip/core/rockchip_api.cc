...
//-----------------------------------------------------------------------------------------------------------------
// https://github.com/rockchip-linux/gstreamer-rockchip/blob/master/gst/rockchipmpp/gstMppJpegDecode.c
...
MppPacket MppJpegDecode::SendBuf(MppBuffer &in_buf, int &w, int &h) {
  ...
  CHECK_MPP_RET(mpp_packet_init_with_buffer(&packet, in_buf),
                "mpp_packet_init failed: ", nullptr);
